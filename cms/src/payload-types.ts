...
export interface Config {
  ...
  collectionsSelect: {
    ...
    'logo-media': LogoMediaSelect<false> | LogoMediaSelect<true>;
...
export interface Category {
  id: string;
  /**
   * MongoDB _id of the legacy document
   */
...
export interface Brand {
  id: string;
  /**
   * Notion ID of the brand
   */
  notionId?: string | null;
  name: string;
  about: string;
  whyOli: string;
  status: 'Live' | 'Staged' | 'Offline';
  backgroundImage: string | Media;
  logoImage: string | LogoMedia;
  tiles?:
    | {
        preTitle: string;
        title: string;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "logo-media_select".
 */
export interface LogoMediaSelect<T extends boolean = true> {
  alt?: T;
  prefix?: T;
  updatedAt?: T;
  createdAt?: T;
