...
- Le **Read side** expose des vues optimisées pour les besoins de l'UI, sans logique métier
...
- **CQRS** : le pattern de séparation read/write
- **Event Sourcing** : le pattern de stockage par événements
- **DDD** : les Commands et Events correspondent aux concepts du domaine (Ubiquitous Language)
- **Value Objects** : utilisés dans les payloads des Commands et Events
- **DTOs** : utilisés sur le Read side pour les projections vers l'UI
