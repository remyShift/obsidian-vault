...
Rust prend une troisième voie : il garantit la sécurité mémoire **à la compilation**, sans GC. Si ton code compile, il ne peut pas avoir ces bugs. Le compilateur les interdit avant même que le programme tourne.
