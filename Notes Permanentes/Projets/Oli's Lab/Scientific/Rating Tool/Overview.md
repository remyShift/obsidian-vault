...
`ewg` et `lancome` sont regroupés sous l'étiquette **"ext"** (external) dans le code. Cette dualité **shop vs ext** est la tension architecturale centrale du projet → voir [[Critique archi - Clean Code & DDD]].
