...
Vérifie que `a` et `b` sont **présents**. Il ne teste **ni l'absence** d'autres éléments, **ni les doublons**, **ni l'ordre**. Pour ces propriétés il faut une assertion explicite :
