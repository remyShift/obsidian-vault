...
- Les numéros de téléphone, étages, dates
- Les transports (lignes de métro, numéros de bus)

> [!question]- 이 가방은 얼마예요?
> Ce sac coûte combien ?
> → 이만 오천 원이에요. (25 000 wons)

> [!question]- 지금 몇 월이에요?
> On est quel mois ?
> → 사월이에요. (Avril = 4e mois)

> [!question]- 지하철 몇 호선이에요?
> C'est quelle ligne de métro ?
> → 이 호선이에요. (La ligne 2)

---

## 2. Les nombres natifs coréens (고유어 수사)
...
**Attention : 하나, 둘, 셋, 넷 changent de forme devant un classificateur**

| Seul | Devant un classificateur |
|------|--------------------------|
| 하나 | 한 |
| 둘 | 두 |
| 셋 | 세 |
...
> [!question]- 사과 몇 개 드릴까요?
> Je vous en donne combien de pommes ?
> → 세 개 주세요. (Trois, s'il vous plaît)

> [!question]- 나이가 몇 살이에요?
> Vous avez quel âge ?
> → 스물다섯 살이에요. (J'ai 25 ans)

---

## 3. Dire l'heure

- L'heure = natifs coréens + **시**
- Les minutes = sino-coréens + **분**
...
## 4. Dire les prix (à Séoul)

Les prix utilisent toujours les sino-coréens + **원**.
