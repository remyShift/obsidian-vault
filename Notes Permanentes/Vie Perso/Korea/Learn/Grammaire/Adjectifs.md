...
tags:
  - Korea
---
En coréen, les adjectifs se comportent comme des **verbes d'état** (형용사, hyeongyongsa). Ils se conjuguent exactement comme les verbes d'action (동사, dongsa) et n'ont pas besoin du verbe "être" séparé.
...
## Forme de base (dictionnaire)

| Français | Adjectif (base) | Verbe d'action (base) |
| -------- | --------------- | --------------------- |
| être grand | 크다 | 가다 (aller) |
| être bon / bien | 좋다 | 먹다 (manger) |
