...
## Positionnement (le fil rouge)

**Développeur par obstination.**

Un autodidacte venu du commerce qui défend le craft comme une culture qu'on se construit, pas un diplôme qu'on décroche. Quelqu'un qui fait le travail lui-même, code comme écriture, à une époque qui pousse au raccourci.

Mon autorité ne vient pas de la maîtrise technique, elle vient du parcours. Je ne joue pas au sachant. Je montre quelqu'un de sérieux qui pratique, se trompe, apprend en chemin et partage le vrai.

## Les 4 piliers

1. **Craft et qualité (sensibilité, pas expertise).** Tests, archi, refacto, dette technique, le "pourquoi" avant la ligne de code. Je n'enseigne pas le craft, je montre que je le pratique et que je progresse dessus. Ton de quelqu'un qui creuse, jamais de quelqu'un qui surplombe.

2. **Le parcours obstiné (ma signature).** Reconversion, autodidaxie, les portes fermées, l'étiquette "junior", et bientôt la Corée. C'est mon récit et personne n'a exactement le même. Mon meilleur registre ici, c'est le non romancé : les galères concrètes, chaotiques, parfois bêtes. Pas la version héroïque.

3. **L'IA avec lucidité (le sujet d'époque).** Pro-outil, anti-paresse, anti-slop. Cohérent avec le pilier 2 : tout part de la même valeur, faire le truc, le digérer, se l'approprier.

4. **Le terrain en build in public (la preuve).** Oli's Lab, mes projets, ce que j'apprends en livrant pour de vrai. Des REX qui apprennent quelque chose au lecteur, pas le journal de bord quotidien.
...
## Le dernier mot, toujours (pas la pureté)
...
Générer, tout le monde sait faire. Relire, digérer, virer ce qui ne sonne pas comme moi et assumer chaque mot, c'est ça la discipline et c'est ça que je vends.

## Ce que je coupe

- Les "objectifs de la semaine / hebdo".
- Les logs de grind jour par jour (style "BIP jour 11").
...
Mon plus gros danger n'est pas le manque de sujets, c'est la régularité subie qui pousse à reposter du vide pour "tenir le rythme". Mieux vaut moins, mais juste. Planifier en batch plutôt qu'espérer la motivation chaque jour. Une ligne forte, c'est autant ce que j'arrête de publier que ce que je publie.
