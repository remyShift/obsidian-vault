...
J'ai fait cette après-midi cette calculatrice en me basant sur l'UI de celle de l'Iphone (lien en commentaire).

Ainsi, j'ai pu renforcer mes connaissances React ainsi que l'utilisation de Zustand.

De plus, j'ai formaté l'affichage en fonction du nombre de digit pour faciliter la lecture.

Aussi, j'ai pris en compte le fait de limiter le nombre de digit afficher et passer à une notation avec exposant si nécessaire.
